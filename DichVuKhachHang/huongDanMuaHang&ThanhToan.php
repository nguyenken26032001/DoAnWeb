...
<head>
    ...
    <title>PAGE HƯỚNG DẪN MUA HÀNG VÀ THANH TOÁN CHO NGƯỜI DÙNG</title>
...
<body>
    <div class="conntentMenu" style="margin-top: 120px;margin-bottom: 200px; font-size: 20px;margin-left: 150px;">
        ...
        <p> <strong>  BƯỚC 1: Truy cập vào website và chọn sản phẩm cần mua </strong>  </p>
        <img src="img/product.PNG" alt="" width="80%">
        <p> <strong> BƯỚC 2: Chọn số lượng và kích thước bạn muốn và nhấn mua ngay hoặc là thêm vào giỏ hàng </strong></p>
        <img src="img/buoc2.PNG" alt="" width="80%">
        <p> <strong>BƯỚC 3: Nếu chọn MUA NGAY thì đến với thanh toán và đặt hàng </strong></p>
        <img src="img/windowThanhToan1.PNG" alt="" width="80%">

        <p> <strong> BƯỚC 4: Nếu bạn chọn THÊM VÀO GIỎ HÀNG thì đến với giỏ hàng và thanh toán như BƯỚC 3</strong></p>
        <img src="img/cart.PNG" alt="" width="80%">
    </div>

...
<div id="container">
        <div id="viewport">
          ...
          date('d-m-Y H:i:s');
                      ...
                      $sql= "select sanPham.id,sanPham.tenHang,sanPham.hinhAnh,sanPham.moTa,sanPham.soLuong,sanPham.donGia,sanPham.ngayUpdate,nhomHang.tenNhom  tenNhomHang from sanpham, nhomHang where sanPham.maNhom=nhomHang.maNhom 

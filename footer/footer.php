...
font-family: 'Source Serif Pro', serif;" class="footer">
        ...
        <div class="info_footer">
            <div id="facebook">
                <img src="../main/img/ảnh me.jpg" alt="ảnh đại diện">
                <i class="fab fa-facebook-square"></i>
                <a href="https://www.facebook.com/tranvannguyen26032001">Nguyện Ken </a>
            </div>
            <div id="zalo">
                <i  class="fas fa-phone-square-alt"></i>
                <a href="https://zalo.me/+84825871266">082 587 1266</a>
            </div>
            <div id="address">
        ...
        <div class="bottom_right">
            <div class="dich_vu">
                ...
                <a id="first" href="../DichVuKhachHang/huongDanMuaHang&ThanhToan.php">Hướng dẫn mua hàng & thanh toán</a>
                <a href="../DichVuKhachHang/chinhSachBaoMat.php">Chính sách bảo mật </a>
                <a href="../DichVuKhachHang/hoTroKhachHang.php">Chính sách hỗ  trợ khách hàng</a>
            </div>

            <div class="content_bottom">
                <p id="title"> Bản quyền trang web thuộc về Trần Văn Nguyện ĐHCTTCK14Z</p>
            </div>
        </div>
    </div>

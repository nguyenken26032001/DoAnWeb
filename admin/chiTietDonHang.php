...
$sql= "SELECT hoadon.maHd,hoadon.userName,hoadon.address, hoadon.phoneNumber, donhang.maHang maHang,donhang.slMua sl ,donhang.donGia gia , donhang.size size , donhang.tenHang tenHang, donhang.ngayDatHang ngayDat,donhang.trangThai trangThai  

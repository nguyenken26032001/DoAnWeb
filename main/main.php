...
<?php  include '../pageHeader/header.php'?>
        ...
        <ul class="product">
            <li>
                ...
                <ul class="sub_trangphuc">
                    <li> <a href="../search/QuanAoDoiTuyen.php" target="_blank"><span>Quần áo Đội Tuyển </span></a></li>
            ...
            <li>
             ...
             <img src="img/shoseSport.png" alt="">
                <a id="shoes" href=""><span style="color: #111; font-size: 15px; font-weight: 400px ; margin-left: 15px;">GIÀY</span> </a>
    ...
    <div style="font-family: 'Abel', sans-serif;
        ...
        font-family: 'Source Serif Pro', serif" class="products">      <!--  phần này để show các sản phẩm -->
         <!-- sản phẩm thứ 1 -->
        <?php
        $limit=12;
        $page=1;

...
if(!empty($_POST)){
   ...
   }else
   {
    ...
    foreach($cart as $item){
        ...
        $slmua=$item['num'];
        $size=$item['size'];
        $sql2="insert into donhang(idHd,maKhachHang,tenHang,maHang,donGia,slMua,size,pttt,ngayDatHang,trangThai,kieuKhachHang)
         value('$order_id','$makh','$tenhang','$mahang','$dongia','$slmua','$size','$pttt','$order_date','Chờ xử lý đơn',$kieukhachhang)";

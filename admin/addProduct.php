...
date_default_timezone_set('Asia/Ho_Chi_Minh');//lấy thời gian của việt nam
      ...
      $sql= "insert into sanpham(tenHang, moTa,maNhom,hinhAnh,donGia,soLuong,ngayTao,ngayUpdate) value('$productName','$content','$category','$thumbnail','$price','$quantity','$ngayTao','$ngayUpdate')";
          execute($sql);
